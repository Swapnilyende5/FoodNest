    ...
    return (
        ...
        >
            <div
                ...
                style={{
                    backgroundImage:
                        "url('https://images.unsplash.com/photo-1494859802809-d069c3b71a8a?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
            ...
            <div className="container position-relative z-1 text-black px-4">
                <div className="col-md-8 col-lg-8">
                    <h1 className="display-3 fw-bold" style={{ fontSize: "70px" }}>
